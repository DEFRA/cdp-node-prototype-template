...
```markdown
| Name                  | Value     | Description                                              | Default | Production | Comment                                            |
| --------------------- | --------- | -------------------------------------------------------- | ------- | ---------- | -------------------------------------------------- |
| `PASSWORD`            | `string`  | Password for basic authentication                        |         |            |                                                    |
| `PASSWORD_KEYS`       | `string`  | Comma-separated list of keys for password authentication |         |            |                                                    |
| `BASE_PLUGINS`        | `string`  | Comma-separated list of base plugins to load             |         |            |                                                    |
| `USE_AUTH`            | `boolean` | Enable basic authentication                              | `true`  | `true`     | Basic auth on in environments                      |
| `PORT`                | `number`  | Port the application runs on                             | `3000`  | `8085`     |                                                    |
| `USE_HTTPS`           | `boolean` | Force HTTPS redirect functionality                       | `false` | `false`    | CDP nginx handles https so the app doesn't have to |
| `USE_AUTO_STORE_DATA` | `boolean` | Automatically store session data                         | `true`  |            |                                                    |
